...
const PostCard = ({ post, onDelete }) => {
  ...
  return (
    <div
      className={`bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 p-5 space-y-4 w-full max-w-2xl ${deleting ? "opacity-50 pointer-events-none" : ""}`}
    >
      {/* User Info */}
