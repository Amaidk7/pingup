...
const ChatBox = () => {
  ...
  return (
    <div className={`flex flex-col h-screen bg-transparent`}>
      ...
      {user && (
        <div
          className={`flex items-center gap-3 px-5 md:px-8 py-3 border-b shrink-0 ${
            isDark
      ...
      <div className="shrink-0 px-4 md:px-8 pb-5 pt-2">
        <div
          className={`flex items-center gap-3 pl-5 pr-2 py-2 rounded-2xl max-w-2xl mx-auto border ${
            isDark
