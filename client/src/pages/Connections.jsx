              ...
              <div className="flex-1">
                ...
                <div className="flex max-sm:flex-col gap-2 mt-4">
                  <button
                    ...
                    className="w-full p-2 text-sm rounded bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer"
                  >
                    View Profile
                  </button>
