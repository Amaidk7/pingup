  ...
  return (
    ...
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm">
        ...
        {/* Preview Canvas */}
        <div
          className="rounded-2xl h-[420px] flex items-center justify-center relative overflow-hidden shadow-2xl"
          style={{ backgroundColor: mode === "text" ? background : "#000" }}
        >
          {mode === "text" && (
            <textarea
              className="bg-transparent text-white w-full h-full p-8 text-lg resize-none focus:outline-none placeholder-white/40 text-center"
            ...
            {bgColors.map((color) => (
              <button
                ...
                className={`w-7 h-7 rounded-full transition-transform cursor-pointer ${
                  background === color ? "scale-125 ring-2 ring-white ring-offset-2 ring-offset-black/80" : "hover:scale-110"
                }`}
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 text-slate-900 bg-white hover:bg-slate-100 active:scale-95 py-3 mt-3 w-full rounded-xl text-sm font-semibold transition cursor-pointer"
        >
