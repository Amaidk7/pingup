  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div
          className="rounded-2xl h-105 flex items-center justify-center relative overflow-hidden shadow-2xl"
          style={{ backgroundColor: mode === "text" ? background : "#000" }}
        >
          {mode === "text" && (
            <textarea
              className="bg-transparent text-white w-full h-full p-8 text-lg resize-none focus:outline-none placeholder-white/30 text-center"
        ...
        <div className="flex gap-2 mt-4">
          ...
          <label
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium transition cursor-pointer ${mode === "media" ? "bg-white text-black" : "bg-white/10 text-white/60 hover:bg-white/15"}`}
          >
            <input
        ...
        <button
          onClick={() =>
            toast.promise(handleCreateStory(), { loading: "Creating..." })
          }
